...
--
-- Table structure for table `ts_matricula`
--

DROP TABLE IF EXISTS `ts_matricula`;
...
--
-- Dumping data for table `ts_matricula`
--

LOCK TABLES `ts_matricula` WRITE;
/*!40000 ALTER TABLE `ts_matricula` DISABLE KEYS */;
/*!40000 ALTER TABLE `ts_matricula` ENABLE KEYS */;
UNLOCK TABLES;
